...
public class TransportUpgradeSettingsAction extends TransportMasterNodeAction<UpgradeSettingsRequest, UpgradeSettingsResponse> {
    ...
    public TransportUpgradeSettingsAction(Settings settings, TransportService transportService, ClusterService clusterService,
            ...
            IndexNameExpressionResolver indexNameExpressionResolver, ActionFilters actionFilters, UsageService usageService) {
        super(settings, UpgradeSettingsAction.NAME, transportService, clusterService, threadPool, actionFilters,
                indexNameExpressionResolver, UpgradeSettingsRequest::new, usageService);
