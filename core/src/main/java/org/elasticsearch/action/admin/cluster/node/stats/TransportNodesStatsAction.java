...
public class TransportNodesStatsAction extends TransportNodesAction<NodesStatsRequest,
    ...
    @Inject
    public TransportNodesStatsAction(Settings settings, ThreadPool threadPool, ClusterService clusterService,
        ...
        super(settings, NodesStatsAction.NAME, threadPool, clusterService, transportService, actionFilters, indexNameExpressionResolver,
                NodesStatsRequest::new, NodeStatsRequest::new, ThreadPool.Names.MANAGEMENT, NodeStats.class, usageService);
