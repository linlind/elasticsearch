...
public class GeoKMeansAggregatorFactory extends ValuesSourceAggregatorFactory<ValuesSource.GeoPoint, GeoKMeansAggregatorFactory> {
    ...
    @Override
    protected Aggregator doCreateInternal(GeoPoint valuesSource, Aggregator parent, boolean collectsFromSingleBucket,
            List<PipelineAggregator> pipelineAggregators, Map<String, Object> metaData) throws IOException {
        return new StreamingKMeansAggregator(name, factories, numClusters, maxStreamingClustersCoeff, distanceCutoffCoeffMultiplier,
                valuesSource, context, parent, pipelineAggregators, metaData);
    }
