...
public class MissingAggregatorFactory extends ValuesSourceAggregatorFactory<ValuesSource, MissingAggregatorFactory> {
    ...
    @Override
    protected MissingAggregator createUnmapped(Aggregator parent) throws IOException {
        return new MissingAggregator(name, factories, null, context, parent);
    }
    ...
    protected MissingAggregator doCreateInternal(ValuesSource valuesSource, Aggregator parent, boolean collectsFromSingleBucket)
            throws IOException {
        return new MissingAggregator(name, factories, valuesSource, context, parent);
    }
