...
public class HDRPercentileRanksAggregator extends AbstractHDRPercentilesAggregator {
    ...
    public HDRPercentileRanksAggregator(String name, Numeric valuesSource, AggregationContext context, Aggregator parent,
            double[] percents, int numberOfSignificantValueDigits, boolean keyed, DocValueFormat format) throws IOException {
        super(name, valuesSource, context, parent, percents, numberOfSignificantValueDigits, keyed, format);
    }
    ...
    public InternalAggregation buildAggregation(long owningBucketOrdinal) {
        ...
        if (state == null) {
            ...
            return new InternalHDRPercentileRanks(name, keys, state, keyed, format);
        }
    }
